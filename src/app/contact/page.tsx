...
export const metadata: Metadata = {
  title: "Contact",
  description: "Get in touch with Dev-Roy.",
};
  ...
  return (
    <div className="max-w-3xl mx-auto py-12 px-4 sm:px-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* Email Block */}
        <div className="p-8 bg-card rounded-3xl border border-border flex flex-col items-center text-center hover:border-accent/50 transition-colors">
        ...
        <div className="p-8 bg-card rounded-3xl border border-border flex flex-col items-center text-center hover:border-accent/50 transition-colors">
          ...
          <p className="text-muted text-sm mb-6">
            You can also find me on various social networks.
          </p>
          <div className="flex gap-4">
            ...
            <a
              href="https://www.instagram.com/isuru.dev"
              target="_blank"
              rel="noopener noreferrer"
              className="p-2 bg-background border border-border rounded-full hover:border-accent hover:text-accent transition-colors"
            >
